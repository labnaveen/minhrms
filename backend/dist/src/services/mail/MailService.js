...
const { MAILGUN_API_KEY, MAILGUN_DOMAIN, MAILGUN_FROM, MAIL_HOST, MAIL_PORT, MAIL_USERNAME, MAIL_PASSWORD, FROM_MAIL, SUPPORT_EMAIL, SMTP_SECURE } = process.env;
...
class MailService {
    static async sendToEmail(email, envelope) {
