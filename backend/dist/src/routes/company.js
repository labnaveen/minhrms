...
const companyController = (0, companyController_1.CompanyController)(index_1.Company);
const options = {
...
router.get('/', (0, Authorize_1.Authorize)('users.show'), (req, res, next) => companyController.getAll(req, res, next, options));
/**
 * @swagger
 ...
 *         description: Success
 */
router.get('/:id', (0, Authorize_1.Authorize)('users.show'), companyController.getById);
/**
 * @swagger
 * /api/company:
 *   post:
 ...
 */
//Creating a Company
router.post('/', (0, Authorize_1.Authorize)('users.show'), companyController.create);
/**
 * @swagger
 * /api/company/{companyId}:
 *   put:
 ...
 */
//Updating a Company
router.put('/:id', (0, Authorize_1.Authorize)('users.show'), companyController.update);
/**
 * @swagger
 * /api/company/{companyId}:
 *   delete:
 ...
 */
//Deleting a Company
router.delete('/:id', Authorize_1.Authorize, companyController.destroy);
